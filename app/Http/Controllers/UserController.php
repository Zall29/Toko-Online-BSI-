...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        'nama' => 'required|max:255', // Nama wajib diisi dengan panjang maksimal 255 karakter
        'email' => 'required|max:255|email|unique:user', // Email harus valid, unik, dan maksimal 255 karakter
        'role' => 'required', // Role wajib diisi
        'hp' => 'required|min:10|max:13', // Nomor HP harus 10-13 karakter
        'password' => 'required|min:4|confirmed', // Password minimal 4 karakter dan terkonfirmasi
        'foto' => 'image|mimes:jpeg,jpg,png,gif|file|max:1024', // Foto harus berupa file gambar tertentu dengan ukuran maksimal 1 MB
        ], [
        ...
        // if ($request->file('foto')) {
        //     $fileName = $this->uploadImage($request, 'foto', 'storage/img-user/', 385, 400);
        //     $user->image()->create(['path' => $fileName]);
        // }
